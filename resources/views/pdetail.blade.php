                                                ...
                                                <div class="mt-11">
                                                    <form action="{{ route('ulasan.store') }}" method="POST">
                                                        ...
                                                        <div class="relative col-span-2 sm:col-span-1 mb-6">
                                                            <input type="text" id="Judul" name="Judul" class="peer w-full rounded border border-gray-700 bg-gray-800 bg-opacity-40 py-1 px-3 text-base leading-8 text-gray-100 placeholder-transparent outline-none transition-colors duration-200 ease-in-out focus:border-indigo-500 focus:bg-gray-900 focus:ring-2 focus:ring-indigo-900" placeholder="Judul Buku" value="{{ $book->Judul }}" readonly />
                                                        ...
                                                        <div class="relative col-span-2 sm:col-span-1 mb-4">
                                                            <input type="text" id="Penulis" name="Penulis" class="peer w-full rounded border border-gray-700 bg-gray-800 bg-opacity-40 py-1 px-3 text-base leading-8 text-gray-100 placeholder-transparent outline-none transition-colors duration-200 ease-in-out focus:border-indigo-500 focus:bg-gray-900 focus:ring-2 focus:ring-indigo-900" placeholder="Penulis Buku" value="{{ $book->Penulis }}" readonly />
